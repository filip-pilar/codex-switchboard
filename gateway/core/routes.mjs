...
export function resolveRoute(body, registry) {
  ...
  let effort = legacy ? Object.entries(legacy.selectors).find(([,selector])=>selector===slug)?.[0] : selected ? registry.selection.effort : body.reasoning?.effort ?? body.reasoning_effort ?? applied.capabilities.defaultEffort;
